/* Ce fichier contiendra le controleur des authentifications */
...
exports.signup = (req, res, next) => {
  ...
  if(regex.test(password)){
    ...
    res.status(400).json({ message: "Le mot de passe doit comporter entre 6 et 15 caractères, posséder au moins un chiffre, une lettre majuscule et minuscule et l'un des caractères spéciaux suivants: #?!@$%^&*-."});
  }
}
